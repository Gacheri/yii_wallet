...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Deposit::className(), ['createdBy' => 'id']);
    }
    ...
    {
        return $this->hasMany(Profile::className(), ['createdBy' => 'id']);
    }
    ...
    {
        return $this->hasMany(Withdrawal::className(), ['createdBy' => 'id']);
    }
}
